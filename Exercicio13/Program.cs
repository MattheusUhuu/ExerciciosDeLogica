/*
13 - Escreva um programa para gerar uma matriz quadrada K de dimensão N.
...
Linhas 0 14 28 85 12 34 47
       ...
       4 17 82 95 47 16 45 
       5 91 63 46 59 17 50 
       EX: Imprimir os valores: 39, 92, 75, 95, 63
*/
...
myArray.PrintElementsBelowTheSecondaryDiagonal(array);
...
public class MyArrayService
{
    ...
    public void PrintElementsBelowTheSecondaryDiagonal(int[,] array)
    {
        Console.WriteLine("Caso os valores forem os de test. Imprimir os valores: 39, 92, 75, 95, 63 \n -------------------------------------");
